...
def get_game_info(lines, filename):
    ...
    home_cipa_info, away_cipa_info = get_cipa_info(filename)
    home_team_id, away_team_id = get_teams_id(filename)
    home_team_info, home_gk_info = get_page_info(page_1_lines, filename, home_cipa_info, home_team_id)
    away_team_info, away_gk_info = get_page_info(page_2_lines, filename, away_cipa_info, away_team_id)
